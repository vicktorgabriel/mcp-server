...
grep -Fxq 'MCP_OAUTH_CIMD=0' "$ENV_FILE"
grep -Fxq 'MCP_OAUTH_CIMD_HOSTS=chatgpt.com' "$ENV_FILE"
grep -Fxq 'MCP_OAUTH_JWKS_CACHE_TTL=3600' "$ENV_FILE"
grep -Fxq 'MCP_OAUTH_PRIVATE_KEY_JWT=0' "$ENV_FILE"
grep -Fxq 'MCP_OAUTH_RESPONSE_ISS=0' "$ENV_FILE"
